...
{
    public class ListPhieuNhap : BaseViewModel
    {
        ...
        public ListPhieuNhap(int mmh, int sl, string tmh, string tdv, double gn, double gb)
        {
        ...
        public ListPhieuNhap(DataRow row)
        {
            this.Ten_MatHang = row["Ma_PhieuNhap"].ToString();
